        ...
        <div class="w-full h-96 flex flex-col items-center relative">
                <div class="w-80 h-72 rounded-lg shadow-lg relative group">
                    ...
                    <div class="absolute flex bottom-0 right-0 m-5 p-1 bg-white rounded-full">
                        <img src="https://media.discordapp.net/attachments/1074418812641882162/1205502126898552832/blue_check.png?ex=65d89a58&is=65c62558&hm=1163d4287af6abe94e4be6f0b8e430c72b64ce3295d9a347f1121838cf75d19c&=&format=webp&quality=lossless&width=450&height=450   " class="w-5 h-5" alt=""/>
